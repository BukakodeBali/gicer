        ...
        <nav class="uk-navbar" uk-navbar>
            <div class="uk-navbar-left">
                <a href="{{ url('/') }}" class="uk-navbar-item uk-logo uk-hidden@m">
                    <img src="{{ asset('assets/images/base/logo-nav-1.png')  }}" class="uk-margin-small-right" alt="logo" style="height: 55px;">
                </a>
                <a href="{{ url('/') }}" class="uk-navbar-item uk-logo uk-visible@m">
                    <img src="{{ asset('assets/images/base/logo-nav-1.png') }}" class="uk-margin-small-right" alt="logo" style="height: 65px;">
                </a>
            </div>
