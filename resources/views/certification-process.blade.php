...
@section('content')
    <!-- alur sertifikasi -->
    <div id="visi-misi" class="uk-container bg-dots-container struktur">
        <div class="uk-container uk-container-small" uk-scrollspy="cls: uk-animation-slide-bottom-small; delay: 500">
            ...
            <h3 style="font-size: 28px;">Keterangan :</h3>
            <hr class="m-0">
            <ul id="keterangan" uk-accordion>
                ...
                <li>
                    ...
                    <div class="uk-accordion-content">
                        ...
                        <ul class="uk-list uk-list-disc">
                            ...
                            <li>Setiap perbedaan pemahaman antara KSManajemen dan organisasi pemohon telah terselesaikan</li>
                            <li>KSManajemen memiliki kompetensi dan kemampuan untuk melaksanakan kegiatan sertifikasi</li>
                ...
                <li>
                    ...
                    <div class="uk-accordion-content">
                        <p>Penerbitan sertifikasi awal pada KSManajemen dilakukan berdasarkan informasi yang disediakan oleh tim audit untuk memutuskan sertifikasi, mencakup :</p>
                        <ul class="uk-list uk-list-disc">
                            <li>Laporan audit,</li>
                            <li>Keterangan pada ketidaksesuaian, dan jika tersedia, koreksi dan tindakan korektif yang dilakukan oleh pelanggan,</li>
                            <li>Konfirmasi tentang informasi yang disediakan untuk KSManajemen yang digunakan dalam pengkajian permohonan, dan</li>
                ...
                <li>
                    ...
                    <div class="uk-accordion-content">
                        ...
                        <ul class="uk-list uk-list-disc">
                            ...
                            <li>KSManajemen akan melakukan review terkait dengan status sertifikasi klien, dimana hasil review digunakan untuk memulihkan status pembekuan menjadi tersertifikasi kembali.</li>
                            <li>KSManajemen akan menginformasikan pemulihan status pembekuan kepada klien secara formal melalui surat tertulis.</li>
                        </ul>
                    </div>
                </li>
            </ul>
